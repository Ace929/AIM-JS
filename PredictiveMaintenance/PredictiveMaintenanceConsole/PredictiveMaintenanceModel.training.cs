...
namespace PredictiveMaintenanceConsole
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\seali\OneDrive\Documents\GitHub\AIM-JS\PredictiveMaintenance\PredictiveMaintenance\ai4i2020.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"Type", @"Type", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=9,MinimumExampleCountPerLeaf=10,NumberOfTrees=4,MaximumBinCountPerFeature=369,FeatureFraction=0.99999999,LearningRate=0.06155467010254649,LabelColumnName=@"Machine failure",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"Machine failure"))      
