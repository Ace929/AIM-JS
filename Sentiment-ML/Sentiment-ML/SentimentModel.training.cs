...
namespace ML_Dot_Net_Slop
{
    public partial class SentimentModel
    {
        public const string RetrainFilePath =  @"C:\Users\seali\OneDrive\Documents\GitHub\AIM-JS\ML-Dot-Net-Slop\ML-Dot-Net-Slop\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.050732166F,L2Regularization=0.36821315F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
